/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: d1bcaab8ef905293470b3cc979aef688)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		WS_CONNECTION_POOL: DurableObjectNamespace<import("./src/index").WsConnectionPool>;
		R2_EMAILS: R2Bucket;
		R2_AVATARS: R2Bucket;
