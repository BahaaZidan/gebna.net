/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 9c31b040ce1e0e0dab0d08c377038b4d)
// Runtime types generated with workerd@1.20251105.0 2025-08-03 
declare namespace Cloudflare {
	...
	interface Env {
		...
		JWT_SECRET: string;
		REFRESH_HMAC_KEY: string;
		BASE_API_URL: string;
		JMAP_BASE_PATH: string;
		JMAP_DOWNLOAD_PATH: string;
		JMAP_UPLOAD_PATH: string;
		R2_EMAILS: R2Bucket;
	}
}
