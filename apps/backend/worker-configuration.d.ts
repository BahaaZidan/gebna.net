/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 09491aeaf3b63222ca4ffdc90c593b17)
// Runtime types generated with workerd@1.20251210.0 2026-01-01 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BackgroundContainer" | "ConversationEventsDurableObject";
	}
	interface Env {
		...
		BACKGROUND_CONTAINER: DurableObjectNamespace<import("./src/index").BackgroundContainer>;
		CONVERSATION_EVENTS: DurableObjectNamespace<import("./src/index").ConversationEventsDurableObject>;
		R2_EMAILS: R2Bucket;
		R2_AVATARS: R2Bucket;
