/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/types/worker-configuration.d.ts --env-interface CloudflareBindings` (hash: 806caf86b6987d9f0f9f56ea65d7a91b)
// Runtime types generated with workerd@1.20260128.0 2025-12-10 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		QUEUE: Queue;
		R2_BUCKET_NAME: "gebna-emails";
		BASE_API_URL: string;
		TURSO_DATABASE_URL: string;
		TURSO_AUTH_TOKEN: string;
		JWT_SECRET: string;
		FORCED_USER_ID: string;
		SEEDING_ENDPOINTS_ENABLED: string;
		CF_ACCOUNT_ID: string;
		CF_R2_ACCESS_KEY_ID: string;
		CF_R2_SECRET_ACCESS_KEY: string;
		BACKGROUND_SECRET: string;
		CONVERSATION_EVENTS_SECRET: string;
		WS_CONNECTION_POOL: DurableObjectNamespace<import("../index").WsConnectionPool>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_BUCKET_NAME" | "BASE_API_URL" | "TURSO_DATABASE_URL" | "TURSO_AUTH_TOKEN" | "JWT_SECRET" | "FORCED_USER_ID" | "SEEDING_ENDPOINTS_ENABLED" | "CF_ACCOUNT_ID" | "CF_R2_ACCESS_KEY_ID" | "CF_R2_SECRET_ACCESS_KEY" | "BACKGROUND_SECRET" | "CONVERSATION_EVENTS_SECRET">> {}
}
