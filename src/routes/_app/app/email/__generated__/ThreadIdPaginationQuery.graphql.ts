...
export type ThreadIdPaginationQuery$variables = {
  after?: string | null | undefined;
  first?: number | null | undefined;
  id: string;
};
export type ThreadIdPaginationQuery$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"ThreadIdThread">;
  } | null | undefined;
};
export type ThreadIdPaginationQuery = {
  response: ThreadIdPaginationQuery$data;
  variables: ThreadIdPaginationQuery$variables;
};
